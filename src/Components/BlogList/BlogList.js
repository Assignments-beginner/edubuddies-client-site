									...
									{allBlogs?.map((blog, key) => (
										<tr key={key}>
											...
											{`${blog?.blogStatus}` === "Denied" && (
												<td class='px-6 py-4 whitespace-nowrap text-left'>
													<p class='text-center text-white rounded-lg bg-red-500'>{`${blog?.blogStatus}`}</p>
												</td>
											)}
											{`${blog?.blogStatus}` === "Approved" && (
												<td class='px-6 py-4 whitespace-nowrap text-left'>
													<p class='text-center text-white rounded-lg bg-green-500'>{`${blog?.blogStatus}`}</p>
												</td>
											)}
											{`${blog?.blogStatus}` === "Pending" && (
												<td class='px-6 py-4 whitespace-nowrap text-left'>
													<p class='text-center text-white rounded-lg bg-yellow-500'>{`${blog?.blogStatus}`}</p>
												</td>
											)}
