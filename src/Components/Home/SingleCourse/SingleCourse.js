						...
						<div className='flex justify-between items-center px-4 pb-2'>
							<div>
								...
								<input
									...
									name='Title'
									autofocus
									className='mx-1 m-0 px-4 py-2 transition duration-300 border border-gray-300 rounded focus:border-transparent focus:outline-none focus:ring-4 focus:ring-blue-200'
								...
								{!used ? (
									<button
										onClick={() => promocode()}
										className='m-0 px-4 py-2 text-lg text-white transition-colors duration-300 bg-red-500 rounded-md shadow hover:bg-red-600 focus:outline-none focus:ring-blue-200 focus:ring-4'>
										Apply
									</button>
								) : (
									<button
