            ...
            <Swiper 
                ...
                <SwiperSlide>
                    ...
                    <div className="slider-text text-left absolute top-1/4 left-1/4">
                        <p className="text-red-600 font-black text-xl tracking-wider mb-3"> Learn & Achieve </p>
                        <h1 className="head-text lg:text-5xl md:text-3xl sm:text-xl mb-8 text-white uppercase font-black">Find The Right Online <br /> Tutor For You</h1>
                        ...
                        Better Education For A Better World. Best Industry Leaders And Learn Courses Online.
                         ...
                         <Link to="/Courses">
                            <button className="border-2 border-white hover:bg-red-600 hover:border-red-600 text-white py-3 px-6 rounded-lg text-lg tracking-wider"> Get Started </button>
                        </Link>
                    </div>
                </SwiperSlide>
                <SwiperSlide>
                    ...
                    <div className="slider-text text-left absolute top-1/4 left-1/4 ">
                    <p className="text-red-600 font-black text-xl tracking-wider mb-3"> Learn & Achieve </p>
                        <h1 className="lg:text-5xl md:text-3xl sm:text-xl mb-8 text-white uppercase font-black head-text">Become A Perfect Developer <br /> With Edu Buddies</h1>
                        <p className="mb-8 text-gray-300 text-xl sm:hidden lg:block description">Better Education For A Better World. Best Industry Leaders And Learn Courses Online <br /> “Learning to code has the inadvertent effect of teaching you how to think,” says Adrian Degus. <br />
                ...
                <SwiperSlide>
                    ...
                    <div className="slider-text text-left absolute top-1/4 left-1/4">
                    <p className="text-red-600 font-black text-xl tracking-wider mb-3"> Learn & Achieve </p>
                        <h1 className="head-text lg:text-5xl md:text-3xl sm:text-xl mb-8 text-white uppercase font-black">Explore A Different Way <br /> To Learn Coding</h1>
