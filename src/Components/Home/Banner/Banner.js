            ...
            <Swiper 
                ...
                <SwiperSlide>
                    ...
                    <div className="slider-text text-left absolute top-1/4 left-1/4">
                        <p className="text-orange-500 font-bold text-xl tracking-wider mb-3"> Learn & Achieve </p>
                        ...
                        <Link to="/Courses">
                            <button className="border-2 border-orange-500 hover:bg-orange-500 text-white font-bold py-3 px-6 rounded-lg">Ready To Get Started ?</button>
                        </Link>
                    </div>
                </SwiperSlide>
                <SwiperSlide>
