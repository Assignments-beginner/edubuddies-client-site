			...
			<Swiper
				...
				<SwiperSlide>
					<img
						...
						alt='SliderImage'
					/>
					<div className='slider-text text-left absolute left-1/4' style={bgStyle}>
						...
						<h3 className='lg:text-3xl md:text-xl sm:hidden md:block lg:block mb-6 text-white uppercase font-bold'>Tutor For You</h3>
				...
				<SwiperSlide>
					...
					<div className='slider-text text-left absolute left-1/4' style={bgStyle}>
						...
						<h3 className='lg:text-3xl md:text-xl sm:hidden md:block lg:block mb-6 text-white uppercase font-bold'>With Edu Buddies</h3>
						<p className='mb-8 text-gray-300 text-lg sm:hidden lg:block description'>
							Better Education For A Better World. Best Industry Leaders And
							Learn Courses Online <br /> “Learning to code has the inadvertent
							effect of teaching you how to think,” says Adrian Degus. <br />
				...
				<SwiperSlide>
					...
					<div className='slider-text text-left absolute left-1/4' style={bgStyle}>
						...
						<h3 className='lg:text-3xl md:text-xl sm:hidden md:block lg:block mb-6 text-white uppercase font-bold'>To Learn Coding</h3>
						<p className='mb-8 text-gray-300 text-lg sm:hidden lg:block description'>
							Better Education For A Better World. Best Industry Leaders And
							Learn Courses Online <br /> “Learning to code has the inadvertent
							effect of teaching you how to think,” says Adrian Degus. <br />
