        ...
        <div className="container mx-auto lg:flex justify-between md:block sm:block">
          <div className='text-left px-6 w-full lg:pt-24'>
              ...
              <div className="text-justify lg:pr-28">
                ...
                students reach their maximum potential in their career.Oxford chimney pot Eaton faff about blower blatant brilliant, bubble and squeak he legged it Charles bonnet arse at public school bamboozled.
              </div>
              <div>
                <Link to="/Courses">
                  <button className="bg-blue-700 text-white py-4 px-8 mt-10 rounded-md mr-2">
                    Join for Free
                  </button>
                </Link>
                <Link to="/register">
